...
const Dongvi = () => {
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        <Text style={styles.title}>Các khối s, p, d và f</Text>
        <Text style={styles.content}>
          &emsp;Vị trí của một nguyên tố trên bảng tuần hoàn có thể cho biết rất nhiều điều về số lượng electron hóa trị mà nguyên tố đó có và những electron hóa trị này có thể nằm trong lớp vỏ con nào. Các khối này được phác thảo trong Hình 4.4.
        </Text>
        <Image
          source={require('../anhlythuyet/4.4.png')}
          style={styles.image}
          resizeMode="contain"
        />
        <Image
          source={require('../anhlythuyet/4.5.png')}
          style={styles.image}
          resizeMode="contain"
        />
        <Text style={styles.content}>
          &emsp;Các kim loại kiềm và kiềm thổ có các electron hóa trị ở phân lớp s. Các nhóm từ 13 đến 18 có các electron hóa trị nằm ở phân lớp p. Các nguyên tố chuyển tiếp có các electron hóa trị của chúng ở phân lớp d, và cuối cùng, các nguyên tố lanthanide và Actinide có các electron hóa trị ở phân lớp f.
</Text>
        <Text style={styles.content}>
          &emsp;Cuối cùng, khi chúng ta di chuyển sang bên phải của bảng tuần hoàn, chúng ta thấy rằng các nguyên tố có thể phản ứng để tạo thành các hợp chất có tính acid. Một số ví dụ là HF, HCl, HBr, HI và H₃O⁺ . Khi chúng ta di chuyển sang bên trái của bảng tuần hoàn, các nguyên tố có thể phản ứng để tạo thành các hợp chất cơ bản như NaOH, KOH và Ca(OH)².
