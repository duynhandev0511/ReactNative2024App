...
const Dongvi = () => {
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        <Text style={styles.title}>Bán kính ion</Text>
        <Text style={styles.content}>
          &emsp;Như đã đề cập ở chương trước, nguyên tử có thể nhận hoặc mất electron. Các ion thu được có thể có bán kính khác với bán kính của nguyên tử ban đầu. Khi phi kim nhận thêm electron thì bán kính ion của anion sẽ lớn hơn bán kính của nguyên tử phi kim. Điều này được thể hiện trong Hình 4.2.
        </Text>
        <Image
          source={require('../anhlythuyet/4.2.png')}
          style={styles.image2}
          resizeMode="contain"
        />
        <Text style={styles.content}>
          &emsp;Điều ngược lại đúng với các nguyên tử và cation kim loại. Kim loại mất electron và sẽ bị giảm bán kính như trên Hình 4.3.
</Text>
        <Image
          source={require('../anhlythuyet/4.3.png')}
          style={styles.image2}
          resizeMode="contain"
        />
      </ScrollView>
