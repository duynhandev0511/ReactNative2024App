...
const Dongvi = () => {
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        <Text style={styles.title}>Cân bằng</Text>
        <Image
          source={require('../anhlythuyet/Bang4chapter4.png')}
          style={styles.image}
          resizeMode="contain"
        />
        <Text style={styles.content}>
          &emsp;Các bán kim loại, hay á kim, được biết là có một số tính chất của kim loại và một số tính chất của phi kim. Các bán kim loại là B, Si, Ge, As, Sb, Te và At . Chúng được tô đậm trong bảng tuần hoàn từng phần ở Hình 4.1. 
</Text>
        <Image
          source={require('../anhlythuyet/4.1.png')}
          style={styles.image2}
          resizeMode="contain"
        />
        <Text style={styles.content}>
          &emsp;Các nguyên tố nằm ở bên trái của bán kim loại là kim loại; những thứ ở bên phải của bán kim loại là phi kim loại. Việc xác định một nguyên tố là kim loại, phi kim hoặc bán kim là rất quan trọng trong việc xác định các xu hướng định kỳ và xác định các loại liên kết mà các nguyên tử sẽ hình thành với nhau.

        </Text>
        <Text style={styles.title}>Vấn đề:</Text>
        <Text style={styles.content}>
          &emsp;Xác định các nguyên tố sau là kim loại, phi kim hoặc bán kim loại: potassium, calcium, bromine, hydrogen và neon.

        </Text>
        <Text style={styles.title}>Giải pháp:</Text>
        <Text style={styles.content}>
          &emsp;K và Ca nằm ở bên trái bảng tuần hoàn và là kim loại. Br và Ne nằm ở phía bên phải của bán kim loại và là phi kim. Hydrogen, mặc dù nằm ở phía bên trái của bảng tuần hoàn, nhưng lại là một phi kim. Nếu bạn vẫn chưa bị thuyết phục về hydrogen, hãy tự hỏi bản thân về các tính chất của khí hydrogen và xem những đặc tính đó phù hợp ở đâu trong biểu đồ so sánh
