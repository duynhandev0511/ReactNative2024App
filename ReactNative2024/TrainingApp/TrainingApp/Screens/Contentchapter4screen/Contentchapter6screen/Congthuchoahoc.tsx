...
const Dongvi = () => {
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        <Text style={styles.title}>Công thức hóa học</Text>
        <Text style={styles.content}>
          &emsp;Công thức hóa học không chỉ cho biết những nguyên tố nào có trong hợp chất mà còn cho biết hàm lượng của mỗi nguyên tố. Có ba loại công thức hóa học khác nhau cần được kiểm tra. Biểu đồ dưới đây cho thấy sự khác biệt chính giữa chúng
</Text>
        <Image
          source={require('../anhlythuyet/Bang1chapter6.png')}
          style={styles.image}
          resizeMode="contain"
        />
        <Text style={styles.title}>Vấn đề:</Text>
        <Text style={styles.content}>
          &emsp;CMột hợp chất có công thức thực nghiệm là CH₂ và có khối lượng mol là 70 gram/mol. Công thức phân tử của hợp chất này là gì?
</Text>
<Text style={styles.title}>Giải pháp:</Text>
<Text style={styles.content}>
          &emsp;Công thức thực nghiệm CH2 có khối lượng là 14. Chia 70 cho 14 để thấy rằng có năm đơn vị CH₂ trong hợp chất này. Điều này có nghĩa là công thức phân tử là C₅H₁₀.
</Text>
