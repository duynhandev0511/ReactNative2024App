...
const Dongvi = () => {
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        <Text style={styles.title}>Sự sắp xếp của bảng tuần hoàn</Text>
        <Text style={styles.content}>
          &emsp;Bảng tuần hoàn chứa một số chu kỳ và nhóm. Các khoảng thời gian là các hàng ngang. Chúng được đánh số từ 1 đến 7. Các nhóm (hoặc họ) là các cột dọc. Chúng được đánh số từ 1 đến 18. Khi chúng ta di chuyển qua các họ hoặc các thời kỳ, chúng ta có thể khám phá ra nhiều xu hướng xảy ra trong bảng tuần hoàn. Điều này được gọi là Luật định kỳ. Bạn sẽ được cung cấp bảng tuần hoàn khi làm bài kiểm tra SAT II: Hóa học. LƯU Ý: Bảng tuần hoàn hoàn chỉnh được cung cấp trong Phụ lục 3 ở cuối cuốn sách này.
        </Text>
      </ScrollView>
    </SafeAreaView>
  );
