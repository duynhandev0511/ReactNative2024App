...
const Dongvi = () => {
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        <Text style={styles.title}>Năng lượng ion hóa</Text>
        <Text style={styles.content}>
          &emsp;Năng lượng ion hóa, như tên gọi của nó, là năng lượng cần thiết để loại bỏ một electron khỏi nguyên tử và tạo thành ion. Khái niệm này sẽ dễ dàng nhận ra trong bảng tuần hoàn một khi bạn đã nắm được ý tưởng về độ âm điện. Phải mất rất nhiều năng lượng để loại bỏ các electron khỏi các octet rất ổn định của khí hiếm. Ví dụ, đối với helium, năng lượng ion hóa thứ nhất là 2372 kJ/mol, trong khi neon có năng lượng ion hóa thứ nhất là 2081 kJ/mol. Fluorine, có độ âm điện cao nhất và khả năng “giữ” electron, có năng lượng ion hóa thứ nhất là 1681 kJ/mol.
        </Text>
        <Text style={styles.content}>
          &emsp;Bây giờ bạn có thể đoán rằng điều ngược lại cũng đúng với kim loại khi bạn tránh xa flo và các khí hiếm. Bằng chứng nằm ở năng lượng ion hóa đầu tiên của sắt (762 kJ/mol) và kali (419 kJ/mol). Những giá trị này chỉ là một phần năng lượng ion hóa đầu tiên đối với một số phi kim nhất định.
        </Text>
        <Text style={styles.title}>Đặt vấn đề</Text>
        <Text style={styles.content}>
          &emsp;Chất nào được cho là có năng lượng ion hóa lớn hơn, Ca hay Br?
        </Text>
        <Text style={styles.title}>Giải pháp</Text>
        <Text style={styles.content}>
          &emsp;Br nằm gần F hơn và sẽ có năng lượng ion hóa cao hơn
        </Text>
      </ScrollView>
    </SafeAreaView>
  );
