...
const Dongvi = () => {
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        <Text style={styles.title}>Các ngoại lệ đối với Quy tắc Octet</Text>
        <Text style={styles.content}>
          &emsp;Có những ngoại lệ đối với quy tắc bát tử. Ví dụ, helium cực kỳ ổn định chỉ với hai electron hóa trị ở mức năng lượng chính ngoài cùng của nó. Điều tương tự cũng đúng với các ion lithium và beryllium. Điều này chỉ ra rằng việc có một octet để ổn định nguyên tử không phải là vấn đề lớn mà vấn đề là phải có mức năng lượng chính đầy đủ ngoài cùng.
Một ngoại lệ cuối cùng đối với quy tắc bát tử nằm ở liên kết của nguyên tử boron. Boron thích sáu electron ở mức năng lượng chính ngoài cùng của nó. Điều này cho phép các hợp chất chứa boron tạo ra ba liên kết theo cách sắp xếp phẳng lượng giác. Hai ví dụ là BH₃ và BF₃ như hình 3.13.
        </Text>
        <Image
          source={require('../anhlythuyet/3.13.png')}
          style={styles.image2}
          resizeMode="contain"
        />
      </ScrollView>
