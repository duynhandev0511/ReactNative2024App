...
const Dongvi = () => {
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        <Text style={styles.title}>Cấu trúc cộng hưởng</Text>
        <Text style={styles.content}>
          &emsp;Cấu trúc cộng hưởng hình thành khi một chất có các electron định vị có thể dịch chuyển bên trong chất đó. Điều này cho phép vẽ nhiều Cấu trúc Lewis. Một số ví dụ lànitrate ion, ozone, và ion carbonate như dưới đây.
        </Text>    
        <Image
          source={require('../anhlythuyet/Hinh2chapter5.png')}
          style={styles.image2}
          resizeMode="contain"
        />
      </ScrollView>
