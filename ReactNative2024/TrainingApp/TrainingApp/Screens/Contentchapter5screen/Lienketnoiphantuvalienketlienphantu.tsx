...
const Dongvi = () => {
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        <Text style={styles.title}>Liên kết nội phân tử và liên kết liên phân tử</Text>
        <Text style={styles.content}>
          &emsp;Chương này xem xét cái gì giữ vật chất lại với nhau. Các “chất keo” chịu trách nhiệm giữ các nguyên tử lại với nhau với các nguyên tử khác và phân tử với các phân tử khác được gọi là liên kết. Liên kết nội phân tử là liên kết được tìm thấy trong các phân tử. Nói cách khác, liên kết nội phân tử giữ các nguyên tử với các nguyên tử khác. Các liên kết này khác nhau tùy thuộc vào loại yếu tố tham gia vào quá trình liên kết. Liên kết liên phân tử là liên kết giữa các phân tử. Những liên kết này mang lại cho các chất những điểm nóng chảy, điểm sôi và áp suất hơi khác nhau.
        </Text>
        <Text style={styles.content}>
          &emsp;Các quy tắc chi phối liên kết giữa các nguyên tử và phân tử có thể khá phức tạp. Có thể đáng để xem lại các chương liên quan đến cấu trúc nguyên tử và bảng tuần hoàn/xu hướng trước khi bạn xử lý tài liệu được trình bày ở đây.
        </Text>
      </ScrollView>
    </SafeAreaView>
  );
