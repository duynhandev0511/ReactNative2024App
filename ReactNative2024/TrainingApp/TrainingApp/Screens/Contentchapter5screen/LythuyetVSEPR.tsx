...
const Dongvi = () => {
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        <Text style={styles.title}>Lý thuyết VSEPR</Text>
        <Text style={styles.content}>
          &emsp;Lý thuyết VSEPR có thể giải thích vị trí của các electron xung quanh nguyên tử trung tâm của phân tử và hình dạng của phân tử khi nó có một số lượng nguyên tử nhất định liên kết với nguyên tử trung tâm. Điều này có thể được tóm tắt bằng biểu đồ sau:
          </Text>
        <Image
          source={require('../anhlythuyet/Bang2chapter5.png')}
          style={styles.image2}
          resizeMode="contain"
        />
