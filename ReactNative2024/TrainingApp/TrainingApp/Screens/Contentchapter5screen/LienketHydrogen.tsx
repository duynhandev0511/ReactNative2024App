...
const Dongvi = () => {
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        <Text style={styles.title}>Liên kết Hydrogen </Text>
        <Text style={styles.content}>
          &emsp;Liên kết hydro là một lực yếu xuất hiện khi hydrogen liên kết với fluorine, oxygen hoặc nitrogen. Một phương pháp ghi nhớ tốt có thể sử dụng là “Chúng tôi đã nghe nói về liên kết hydrogen trên FON (điện thoại)”. Khi hydrogen liên kết với fluorine, oxygen hoặc nitrogen, hydrogen sẽ tạo thành liên kết hydrogen yếu với nguyên tử fluorine, oxygen hoặc nitrogen lân cận. Đường đứt nét trong Hình 5.24 cho thấy các liên kết hydrogen được hình thành giữa các nguyên tử hydrogen và oxygen trong nước.
        </Text>
        <Image
          source={require('../anhlythuyet/5.24.png')}
          style={styles.image2}
          resizeMode="contain"
        />
        <Text style={styles.content}>
          &emsp;Một ứng dụng quan trọng của liên kết hydrogen nằm trong mã di truyền của chúng ta – DNA. Trong một phân tử DNA, hai sợi được giữ cạnh nhau ở các nitrogen base. Đó là liên kết hydrogen giữ nitrogen base của một sợi với nitrogen base của sợi thứ hai. Liên kết hydrogen đủ mạnh ở dạng  số lượng lớn hơn để giữ các sợi cạnh nhau và giúp DNA tạo ra cấu trúc xoắn kép. Tuy nhiên, khi DNA sao chép, các liên kết hydro đủ yếu để bị phá vỡ nên mỗi chuỗi có thể được sao chép riêng lẻ. (Xem Hình 5.25.)
        </Text>
        <Image
          source={require('../anhlythuyet/5.25.png')}
          style={styles.image2}
          resizeMode="contain"
        />
        <Text style={styles.content}>
          &emsp;Liên kết hydro cũng là nguyên nhân khiến nước có nhiệt độ sôi cao bất thường. Các phân tử nặng hơn như H₂S, không có liên kết hydrogen, nên có nhiệt độ sôi cao hơn phân tử nước nhẹ hơn nhiều. Nhưng mặc dù nhẹ hơn nhưng nước có nhiệt độ sôi cao hơn vì nó có liên kết hydrogen còn hydrogen sulfide thì không. (Xem Hình 5.26.)
        </Text>
        <Image
          source={require('../anhlythuyet/5.26.png')}
          style={styles.image2}
          resizeMode="contain"
        />     
      </ScrollView>
